...
//        }
    ...
    public boolean isTokenValid(String token, UserDetails userDetails) {
        ...
        System.out.println(userName.equals(((User) userDetails).getLogin()));
        System.out.println(userName);
        System.out.println(((User) userDetails).getLogin());
        return (userName.equals(((User) userDetails).getLogin())) && !isTokenExpired(token);
    }
    ...
    private String generateToken(Map<String, Object> extraClaims, User userDetails) {
        return Jwts.builder().setClaims(extraClaims).setSubject(userDetails.getLogin())
